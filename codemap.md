# Repository Atlas: oh-my-openagent-slim

## Project Responsibility

**oh-my-openagent-slim** is a lightweight agent orchestration plugin for OpenCode - a slimmed-down fork of oh-my-opencode. It provides a multi-agent system that enables specialized AI agents to work together under an orchestrator to optimize coding tasks for quality, speed, cost, and reliability.

The plugin integrates with OpenCode to provide:
- **Multi-agent orchestration** with specialized roles (Ra, Horus, Thoth, Oracle, Bastet, Anubis)
...
|------|---------|-------------|
| `package.json` | Project manifest, dependencies, and build scripts | `oh-my-openagent-slim` CLI, `dist/index.js` main entry |
